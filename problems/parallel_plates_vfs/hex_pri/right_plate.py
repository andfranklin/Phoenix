...
p1 = model.geo.addPoint(10.0,  0.0,  0.0, 10.0 / n_elems)
p2 = model.geo.addPoint(10.0, 10.0,  0.0, 10.0 / n_elems)
p3 = model.geo.addPoint(10.0, 10.0, 10.0, 10.0 / n_elems)
p4 = model.geo.addPoint(10.0,  0.0, 10.0, 10.0 / n_elems)
